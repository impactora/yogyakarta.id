...
<template>
  <nav
    class="fixed top-0 left-0 right-0 z-[100] px-5 lg:px-[60px] h-[60px] lg:h-[72px] flex items-center justify-between bg-parchment/94 backdrop-blur-md border-b border-line"
  >
    <NuxtLink
      to="/"
